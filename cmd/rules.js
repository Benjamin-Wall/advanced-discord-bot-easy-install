...
var rules1 = new Discord.EmbedBuilder()
        .addFields({ name: "Rules (1/2):", value: "---------------------------------------------------------------------------------------\n" +
...
var rules2 = new Discord.EmbedBuilder()
        .addFields({ name: "Rules (2/2):", value: "__**8.**__ No using peoples usernames and/or posing as them. \n" +
